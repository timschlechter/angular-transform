    ...
    function(angularTransform, template, _) {
        ...
        describe('angularTransform', function() {
            ...
            it("first try", function() {
                ...
                expect(result).toBe('<?xml version="1.0" encoding="UTF-8"?><company><name>Some Company</name><employees><employee><name age="29">Jill</name></employee><employee><name age="31">Jack</name></employee></employees></company>');
            });
        });
    }
);
